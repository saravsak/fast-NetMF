...
#time ./small_sparse_cpu $DATASET $W $DIM 1 ../../fnmf-data/${DATASET}/csr/ /scratch/SK/fnmf_embeddings/mkl_sparse_${DATASET}_${DIM}_${W}_1_NMF.emb NMF 32
#time ./small_dense_cpu $DATASET $W $DIM 1 ../../fnmf-data/${DATASET}/dense/ /scratch/SK/fnmf_embeddings/mkl_dense_${DATASET}_${DIM}_${W}_1_NMF.emb NMF 32
#time ./small_sparse_cpu $DATASET $W $DIM 1 ../../fnmf-data/${DATASET}/csr/ /scratch/SK/fnmf_embeddings/mkl_sparse_${DATASET}_${DIM}_${W}_1_SVD.emb SVD
#time ./small_dense_cpu $DATASET $W $DIM 1 ../../fnmf-data/${DATASET}/dense/ /scratch/SK/fnmf_embeddings/mkl_dense_${DATASET}_${DIM}_${W}_1_SVD.emb SVD
#time ./small_sparse_cpu $DATASET $W $DIM 1 ../../fnmf-data/${DATASET}/csr/ /scratch/SK/fnmf_embeddings/mkl_sparse_${DATASET}_${DIM}_${W}_1_NMF.emb NMF 32
#time ./small_dense_cpu $DATASET $W $DIM 1 ../../fnmf-data/${DATASET}/dense/ /scratch/SK/fnmf_embeddings/mkl_dense_${DATASET}_${DIM}_${W}_1_NMF.emb NMF 32
...
time python ~/NetMF/predict.py --label ~/fnmf-data/${DATASET}.mat --embedding /scratch/SK/fnmf_embeddings/mkl_dense_${DATASET}_${DIM}_${W}_1_NMF.emb --seed 10 --out-path ./mkl_result.csv --algorithm netmf-small-mkl-dense --dataset ${DATASET} --window $W --dimension $DIM --b 1 --fact NMF
time python ~/NetMF/predict.py --label ~/fnmf-data/${DATASET}.mat --embedding /scratch/SK/fnmf_embeddings/mkl_sparse_${DATASET}_${DIM}_${W}_1_NMF.emb --seed 10 --out-path ./mkl_result.csv --algorithm netmf-small-mkl-sparse --dataset ${DATASET} --window $W --dimension $DIM --b 1 --fact NMF
