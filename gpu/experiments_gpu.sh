...
time ./small_sparse_gpu $DATASET $W $DIM 1 ../../fnmf-data/${DATASET}/csr/ /scratch/SK/fnmf_embeddings/gpu_sparse_${DATASET}_${DIM}_${W}_1_SVD.emb SVD
time ./small_dense_gpu $DATASET $W $DIM 1 ../../fnmf-data/${DATASET}/dense/ /scratch/SK/fnmf_embeddings/gpu_dense_${DATASET}_${DIM}_${W}_1_SVD.emb SVD
time ./small_sparse_gpu $DATASET $W $DIM 1 ../../fnmf-data/${DATASET}/csr/ /scratch/SK/fnmf_embeddings/gpu_sparse_${DATASET}_${DIM}_${W}_1_SVD.emb SVD
time ./small_dense_gpu $DATASET $W $DIM 1 ../../fnmf-data/${DATASET}/dense/ /scratch/SK/fnmf_embeddings/gpu_dense_${DATASET}_${DIM}_${W}_1_SVD.emb SVD
time ./small_sparse_gpu $DATASET $W $DIM 1 ../../fnmf-data/${DATASET}/csr/ /scratch/SK/fnmf_embeddings/gpu_sparse_${DATASET}_${DIM}_${W}_1_SVD.emb SVD
time ./small_dense_gpu $DATASET $W $DIM 1 ../../fnmf-data/${DATASET}/dense/ /scratch/SK/fnmf_embeddings/gpu_dense_${DATASET}_${DIM}_${W}_1_SVD.emb SVD
...
time ./small_sparse_gpu $DATASET $W $DIM 1 ../../fnmf-data/${DATASET}/csr/ /scratch/SK/fnmf_embeddings/gpu_sparse_${DATASET}_${DIM}_${W}_1_NMF.emb NMF 32
time ./small_dense_gpu $DATASET $W $DIM 1 ../../fnmf-data/${DATASET}/dense/ /scratch/SK/fnmf_embeddings/gpu_dense_${DATASET}_${DIM}_${W}_1_NMF.emb NMF 32
time ./small_sparse_gpu $DATASET $W $DIM 1 ../../fnmf-data/${DATASET}/csr/ /scratch/SK/fnmf_embeddings/gpu_sparse_${DATASET}_${DIM}_${W}_1_NMF.emb NMF 32
time ./small_dense_gpu $DATASET $W $DIM 1 ../../fnmf-data/${DATASET}/dense/ /scratch/SK/fnmf_embeddings/gpu_dense_${DATASET}_${DIM}_${W}_1_NMF.emb NMF 32
time ./small_sparse_gpu $DATASET $W $DIM 1 ../../fnmf-data/${DATASET}/csr/ /scratch/SK/fnmf_embeddings/gpu_sparse_${DATASET}_${DIM}_${W}_1_NMF.emb NMF 32
time ./small_dense_gpu $DATASET $W $DIM 1 ../../fnmf-data/${DATASET}/dense/ /scratch/SK/fnmf_embeddings/gpu_dense_${DATASET}_${DIM}_${W}_1_NMF.emb NMF 32
